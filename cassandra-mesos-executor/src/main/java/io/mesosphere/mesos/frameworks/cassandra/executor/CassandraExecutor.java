    ...
    private void startJob(@NotNull final ExecutorDriver driver, @NotNull final TaskInfo task, @NotNull final TaskDetails taskDetails) {
        ...
        switch (nodeJob.getJobType()) {
            ...
            case CLEANUP:
                ...
                break;
            case BACKUP:
                job = new NodeBackupJob(task.getTaskId(), nodeJob.getBackupDir(), nodeJob.getBackupName(), executorService);
                break;
            case RESTORE:
                job = new NodeRestoreJob(task.getTaskId(), nodeJob.getBackupDir(), nodeJob.getBackupName(), executorService);
                break;
            default:
                return;
        }
