...
function main {(
    ...
    export CASSANDRA_FILE_PATH=$(pwd)/cassandra-dist/target/tarball/apache-cassandra-*.tar.gz
    ...
    java -cp $(pwd)/cassandra-dist/target/cassandra-framework.jar io.mesosphere.mesos.frameworks.cassandra.Main
